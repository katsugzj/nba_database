            ...
            <tr>
                <td style="height: 60px" colspan="2">
                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="640">
                        <tr>
                            <td>
                                <img alt="" border="0" height="80" name="newsCenter_r2_c1" src="../img/nba-icon.png"
                                    width="50" /></td>
                            <td>
                    ...
                    <asp:TreeView ID="TreeView1" runat="server">
                        <Nodes>
                            ...
                            <asp:TreeNode Text="新闻管理" Value="新闻管理">
                                <asp:TreeNode NavigateUrl="adminSort.aspx" Text="类别管理" Value="类别管理">
                                </asp:TreeNode>
                                <asp:TreeNode NavigateUrl="adminNews.aspx" Text="新闻管理" Value="新闻管理">
                                </asp:TreeNode>
                                <asp:TreeNode NavigateUrl="addNews.aspx" Text="添加新闻" Value="添加新闻">
                                </asp:TreeNode>
                            </asp:TreeNode>
                        </Nodes>
                    </asp:TreeView>
