<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateRetire.aspx.cs" Inherits="admin_updateRetire" %>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ...
                        <tr>
                            <td class="style2" style="text-align: right">
                                球队：</td>
                            <td style="text-align: left">
                                <asp:DropDownList ID="ddlteam" runat="server" DataSourceID="SqlDataSource1" DataTextField="teamname" DataValueField="teamname">
                                </asp:DropDownList>
