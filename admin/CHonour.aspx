<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CHonour.aspx.cs" Inherits="admin_CHonour" %>
    ...
    <div>
        <table border="0" cellpadding="0" cellspacing="0" width="600" align="center" class="auto-style5">
            ...
            <tr style="font-size: 10pt; color: #000000" >
                ...
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" Height="100%" DataKeyNames="honouryear,playerid">
                        <Columns>
                            <asp:BoundField DataField="honouryear" HeaderText="年份" SortExpression="honouryear" ReadOnly="True" />
                            <asp:BoundField DataField="playerid" HeaderText="playerid" SortExpression="playerid" Visible="False" ReadOnly="True" />
                            <asp:BoundField DataField="playername" HeaderText="球员" SortExpression="playername" />
                            <asp:HyperLinkField DataNavigateUrlFields="honouryear,playerid" DataNavigateUrlFormatString="updateHonour.aspx?honouryear={0}&playerid={1}" Text="修改" HeaderText="修改" />
                            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" ShowHeader="True" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NBA %>" DeleteCommand ="delete from honour where honouryear=@honouryear and playerid = @playerid" SelectCommand="SELECT honour.honouryear, honour.playerid, player.playername FROM honour INNER JOIN player ON honour.playerid = player.id"></asp:SqlDataSource> 
                </td>
            </tr>
        </table>
