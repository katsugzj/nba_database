<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CGame.aspx.cs" Inherits="admin_CGame" %>
            ...
            <tr style="font-size: 10pt; color: #000000" >
                ...
                <td align="center">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" Height="100%" DataKeyNames="id">
                        <Columns>
                            <asp:BoundField DataField="gametime" HeaderText="比赛时间" SortExpression="gametime" />
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="updateGame.aspx?id={0}" Text="修改" HeaderText="修改" />
                            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" ShowHeader="True" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NBA %>" DeleteCommand ="delete from game where id = @id " SelectCommand="SELECT [gametime], [host], [visitor], [id] FROM [game]"></asp:SqlDataSource>
