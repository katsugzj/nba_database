<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRetire.aspx.cs" Inherits="admin_CRetire" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" align="center" class="auto-style5">
            ...
            <tr style="font-size: 10pt; color: #000000" >
                ...
                <td align="center">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="teamname,retirenumber" DataSourceID="SqlDataSource1" Width="100%" Height="100%">
                        <Columns>
                            <asp:BoundField DataField="teamname" HeaderText="队名" ReadOnly="True" SortExpression="teamname" />
                            <asp:BoundField DataField="retirenumber" HeaderText="退役号码" ReadOnly="True" SortExpression="retirenumber" />
                            <asp:HyperLinkField DataNavigateUrlFields="teamname,retirenumber" DataNavigateUrlFormatString="updateTeam.aspx?teamname={0}&retirenumber={1}" Text="修改" HeaderText="修改" />
                            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" ShowHeader="True" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:NBA %>" DeleteCommand ="delete from retire where teamname = @teamname and retirenumber = @retirenumber" SelectCommand="SELECT [teamname], [retirenumber] FROM [retire]"></asp:SqlDataSource>
